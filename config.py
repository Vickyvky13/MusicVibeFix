...
AUTO_RESTART = bool(getenv("AUTO_RESTART", False))


# Set this to True if you want the bot to restart when RAM usage exceeds 90%.
RAM_OVERLOAD_RESTART = bool(getenv("RAM_OVERLOAD_RESTART", False))


# Set this to True if you want the bot to restart when CPU usage exceeds 95%.
CPU_OVERLOAD_RESTART = bool(getenv("CPU_OVERLOAD_RESTART", False))
